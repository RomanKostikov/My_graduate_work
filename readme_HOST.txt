...
- необходимая команда для терминала в pyCharm в django с сохранением нужной кодировки(чтобы киррилица сохранялася)
...
(Принудительно поставил в FileZilla кодировка UTF-8<- это вероятно не обязательно)
...
Все, проект развернут на хосте beget.com с подключенной полноценной БД MySQL.

DOMEN + SSL:

1. Регистрация домена по выбору производится за дополнительную плату прямо на хосте.
Интуитивно понятно
2. (Перенос ранее зарегистрированного бесплатного домена на другом источнике, тоже за доп плату).
