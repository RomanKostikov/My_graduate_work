...
В файле settings.py необходимо указать HOST на котором буде открываться проект или можно указать *, тогда все хосты
будут проходить:
...
4. https://vpsup.ru/stati/ustanovka-postgresql-na-ubuntu.html - настройка phppgadmin;
